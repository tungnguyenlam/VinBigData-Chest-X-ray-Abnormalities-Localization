...
class HardwarePreset:
    ...
    @classmethod
    def small(cls, root: str | None = None, arch: Literal["yolo", "faster_rcnn", "detr"] = "yolo") -> "HardwarePreset":
    ...
    @classmethod
    def medium(cls, root: str | None = None, arch: Literal["yolo", "faster_rcnn", "detr"] = "yolo") -> "HardwarePreset":
    ...
    @classmethod
    def large(cls, root: str | None = None, arch: Literal["yolo", "faster_rcnn", "detr"] = "yolo") -> "HardwarePreset":
